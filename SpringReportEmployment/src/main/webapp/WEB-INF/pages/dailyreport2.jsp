		...
		<form:form id="drForm" modelAttribute="dailyreport" method="POST"
			...
			<table>
				...
				<tr>
					...
					<td><form:input path="prepaidIncrease"
							value="${dailyreport.prepaidIncrease}" style="width:100px;" /></td>
				...
				<tr>
					...
					<td><form:input path="postpaidIncrease"
							value="${dailyreport.postpaidIncrease}" style="width:100px;" /></td>
				...
				<tr>
					...
					<td><form:input path="fixedIncrease"
							value="${dailyreport.fixedIncrease}" style="width:100px;" /></td>
				...
				<tr>
					...
					<td><form:input path="gphoneIncrease"
							value="${dailyreport.gphoneIncrease}" style="width:100px;" /></td>
				...
				<tr>
					...
					<td><form:input path="fiberIncrease"
							value="${dailyreport.fiberIncrease}" style="width:100px;" /></td>
				...
				<tr>
					...
					<td><form:input path="megaIncrease"
							value="${dailyreport.megaIncrease}" style="width:100px;" /></td>
				...
				<tr>
					...
					<td><form:input path="mytvIncrease"
							value="${dailyreport.mytvIncrease}" style="width:100px;" /></td>
				...
				<tr>
					...
					<td><form:input path="ivanIncrease"
							value="${dailyreport.ivanIncrease}" style="width:100px;" /></td>
				...
				<tr>
					...
					<td><form:input path="vneduIncrease"
							value="${dailyreport.vneduIncrease}" style="width:100px;" /></td>
				...
				<tr>
					...
					<td><form:input path="cardIncrease"
							value="${dailyreport.cardIncrease}" style="width:100px;" /></td>
				...
				<tr>
					...
					<td><form:input path="chargeIncrease"
							value="${dailyreport.chargeIncrease}" style="width:100px;" /></td>
			...
			<tr>
				<td colspan="2" align="left"><input type="button"
					value="Save Report" onclick="doAjaxPost()"></td>
				<td colspan="2" align="left"><input id="btnSave"
					name="addVendor" type="button" value="saveReport"></td>
				<td colspan="2" align="left"><input id="btnEdit" type="button"
					value="editReport" disabled="disabled"></td>
				<td colspan="2" align="left"><input id="btnSend" type="submit"
					value="sendReport"></td>
			</tr>
			<br />
			<br />
