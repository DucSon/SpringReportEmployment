...
<title>AddUser</title>
	...
	h1 { font-size:1.8em; }
	.treeview { overflow:auto; border:1px solid silver; min-height:100px; }
	</style>
</head>
<body>
   <h3>Enter user name and repeat password:</h3>    
	<div align="left">
   <form:form id ="adduser" action="/SpringReportEmployment/addUser" modelAttribute="userForm" method='POST'>
      <table>
				<tr>
					<td>User:</td>
				...
				<tr>
					<td>Manager:</td>
					<td><input type='text' id="managername" name='managername' value=''></td>
					<td><input id="managerid" name='managerid' type="hidden" value=''></td>
					<td>
